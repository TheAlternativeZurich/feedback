...
class srcTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\AdministrationController' => 'getAdministrationControllerService.php',
            'App\\Controller\\Administration\\Base\\BaseController' => 'getBaseControllerService.php',
            'App\\Controller\\Administration\\FrontendUserController' => 'getFrontendUserControllerService.php',
            'App\\Controller\\Administration\\SettingsController' => 'getSettingsControllerService.php',
            'App\\Controller\\Api\\Base\\BaseApiController' => 'getBaseApiControllerService.php',
            'App\\Controller\\Api\\VoteController' => 'getVoteControllerService.php',
            'App\\Controller\\Base\\BaseController' => 'getBaseController2Service.php',
            'App\\Controller\\Base\\BaseDoctrineController' => 'getBaseDoctrineControllerService.php',
            'App\\Controller\\Base\\BaseFormController' => 'getBaseFormControllerService.php',
            'App\\Controller\\Base\\BaseUserController' => 'getBaseUserControllerService.php',
            'App\\Controller\\ContactController' => 'getContactControllerService.php',
            'App\\Controller\\EmailController' => 'getEmailControllerService.php',
            ...
            'console.command.public_alias.App\\Command\\SecurityCommand' => 'getSecurityCommandService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/Extension/TwigExtension.php';
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(($this->privates['twig.loader.native_filesystem'] ?? $this->getTwig_Loader_NativeFilesystemService()), array('paths' => array(($this->targetDirs[3].'/templates') => NULL), 'debug' => true, 'strict_variables' => true, 'form_themes' => $this->parameters['twig.form.resources'], 'exception_controller' => 'twig.controller.exception::showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(($this->privates['App\Extension\TwigExtension'] ?? $this->getTwigExtensionService()));
    ...
    /**
     * Gets the private 'App\Extension\TwigExtension' shared autowired service.
     *
     * @return \App\Extension\TwigExtension
     */
    protected function getTwigExtensionService()
    {
        return $this->privates['App\Extension\TwigExtension'] = new \App\Extension\TwigExtension(($this->services['translator'] ?? $this->getTranslatorService()));
    }
    ...
    {
        return $this->privates['assets._default_package'] = new \Symfony\Component\Asset\PathPackage('', ($this->privates['assets._version__default'] ?? $this->privates['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy(($this->targetDirs[3].'/public/dist/manifest.json'))), ($this->privates['assets.context'] ?? $this->getAssets_ContextService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rWuUElZmP2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gCFLMvwCYU', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wLyRug9+8Z', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PFbY9zjW9f', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QTKVylK7sV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XNU37TvWAU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_Access_DecisionManager_InnerService()
    {
        return $this->privates['debug.security.access.decision_manager.inner'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\Security\Voter\FrontendUserVoter'] ?? $this->privates['App\Security\Voter\FrontendUserVoter'] = new \App\Security\Voter\FrontendUserVoter());
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'login_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'APP_SECRET': $value = $this->getEnv('APP_SECRET'); break;
            case 'DATABASE_URL': $value = $this->getEnv('DATABASE_URL'); break;
            case 'MAILER_URL': $value = $this->getEnv('MAILER_URL'); break;
            case 'MAILER_SENDER': $value = $this->getEnv('MAILER_SENDER'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'twig.form.resources' => array(
                ...
                1 => 'bundles/TwigBridge/Form/form_layout.html.twig',
                2 => 'bundles/TwigBridge/Form/fields.html.twig',
            ),
            ...
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\SecurityCommand',
